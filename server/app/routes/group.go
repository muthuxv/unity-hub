...
func GroupRoutes(r *gin.Engine) {
	...
	r.GET("/groups/:id", controllers.Get(func() interface{} { return &models.Group{} }, controllers.PreloadField{Association: "Members", Fields: []string{"id", "pseudo", "profile"}}, controllers.PreloadField{Association: "Channel"}))
