                            ...
                            child: SizedBox(
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                        ...
                                        child: Container(
                                          ...
                                          decoration: BoxDecoration(
                                            ...
                                            border: Border.all(
                                              ...
                                              color: const [Colors.pink][index % 3],
                                              //gradient border
                                            ),
                                          ),
                                          child: GestureDetector(
                                  ...
                                  String filename = _servers[index - 1]['Media']['FileName'];
                                  ...
                                  return Padding(
                                    ...
                                    child: GestureDetector(
                                      onTap: () {
                                        ...
                                        setState(() {
                                          _selectedServer = _servers[index - 1];
                                        });
                                      },
                                      child: Container(
                                        padding: const EdgeInsets.all(5.0),
                                        decoration: BoxDecoration(
                                          ...
                                          color: _selectedServer['ID'] == _servers[index - 1]['ID']
                                              ? Colors.white
                            ...
                            child: Column(
                              children: [
                                Row(
                                  ...
                                  children: [
                                    Text(
                                      _selectedServer['Name'] ?? 'No server selected',
                                      style: TextStyle(
                                        fontSize: 20.0,
                                ...
                                //members panel
                                //MembersPanel(serverId: _selectedServer['ID']),
                                //channels panel
                                ChannelsPanel(serverId: _selectedServer['ID']),
                              ],
                            ),
                          ),
                        ),
